...
export async function build_bundle(
  ...
  console.log(wallet_2_pay_jito_fees_keypair)
  ...
  return new Promise((resolve) => {
    ...
    c.onBundleResult(
      ...
      (result) => {
        ...
        if (isResolved == false && bundleId === response_bund){
...
export const onBundleResult1 = (c: SearcherClient) => {
  c.onBundleResult(
    result => {
      if (response_bund === result.bundleId) {
